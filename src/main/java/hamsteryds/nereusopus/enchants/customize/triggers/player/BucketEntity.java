...
public class BucketEntity extends Trigger {
    public BucketEntity() {
        super(ActionType.BUCKET_ENTITY);
    }

    @Override
    public Pair<ParamType, Object> get(Event evt, String name) {
        PlayerBucketEntityEvent event = (PlayerBucketEntityEvent) evt;
        ParamType type = null;
        Object object = null;
    ...
    public void set(Event evt, String name, Object value) {
        PlayerBucketEmptyEvent event = (PlayerBucketEmptyEvent) evt;
        if (name.equals("cancel")) {
