...
public class ExpChange extends Trigger {
    public ExpChange() {
        super(ActionType.EXP_CHANGE);
    }

    @Override
    public Pair<ParamType, Object> get(Event evt, String name) {
        PlayerExpChangeEvent event = (PlayerExpChangeEvent) evt;
        ParamType type = null;
        Object object = null;
